...
public class Venta {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE) // Anotación para especificar que el valor de la clave primaria es generado automáticamente mediante una secuencia, lo cual es común en bases de datos que soportan secuencias
